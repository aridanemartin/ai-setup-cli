---
trigger: glob
globs: "**/*.test.*,**/*.spec.*,**/*_test.*,**/test_*.*,**/tests/**,**/__tests__/**"
---

<!-- This rule loads only when Windsurf is working on test files, keeping it out of context
     during all other tasks. If you add a testing convention, add it here — not in AGENTS.md
     — so the rule stays focused and only loads when it's actually relevant. -->
